...
from peerstash.cli import (cmd_backup, cmd_cancel, cmd_id, cmd_list, cmd_login,
                           cmd_prune, cmd_register, cmd_restore, cmd_schedule)

# Create the main cli app
cli = typer.Typer(help="PeerStash CLI Tool")
cli.command(name="login")(cmd_login.login)
