...
def _setup_oauth(admin_pass: str) -> tuple[str, str]:
    ...
    typer.secho("    You can create one for free at https://login.tailscale.com/start", fg=typer.colors.YELLOW)
...
def login():
    ...
    try:
        ...
        if typer.confirm(
            ...
            client_id, client_secret = _setup_oauth(admin_pass)
    except ValueError as e:
