...
docker exec peerstash-control-test bash -c "pip install uv && cd /app/testing && UV_PROJECT_ENVIRONMENT=/tmp/.venv uv run pytest tests/test_integration_docker.py -v"
